...
public interface GameFactory {
    // step 1 in refactoring for abstract factory: create an interface for the
    // abstract factory
    ...
    // these call the interfaces created for the variant classes (i.e., interfaces:
    // WorldLayout, WorldAging, Winner, UnitAction)
    // the createX() methods will be called in the GameImpl constructor to reference
    // the factories
}
